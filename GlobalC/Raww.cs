...
namespace GlobalC
{
  // Since NFSW's decompressed JDLZ files contains RAWW format, it's a must to being able to deal with those files.
  // I implement the job done by "MWisBest" on 23 Jan 2016 to this program in order to create a toolbox for NFSW.
  // https://github.com/MWisBest/OpenNFSTools/blob/master/LibNFS/Compression/RAWW.cs
